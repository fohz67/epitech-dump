...
static int my_is_alpha (char *str)
{
    if (str < '0')
        return 1;
    if (str > '9' && str < 'A')
...
static int my_nb_word(char *str)
{
    int nb = 0;
    int a = 0;
...
static void my_malloc(char *str, char **tab, int word)
{
    int a = 0;
    int b = 0;
    int c = 0;
...
static void my_tab(char *str, char **tab, int word)
{
    int a = 0;
    int b = 0;
    int c = 0;
